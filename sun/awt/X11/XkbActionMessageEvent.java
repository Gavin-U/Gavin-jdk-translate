...
public class XkbActionMessageEvent extends XWrapperBase { 
	...
	public int get_keycode() { log.finest("");return (Native.getInt(pData+28)); }
	public void set_keycode(int v) { log.finest(""); Native.putInt(pData+28, v); }
	public boolean get_press() { log.finest("");return (Native.getBool(pData+32)); }
	public void set_press(boolean v) { log.finest(""); Native.putBool(pData+32, v); }
	public boolean get_key_event_follows() { log.finest("");return (Native.getBool(pData+36)); }
	public void set_key_event_follows(boolean v) { log.finest(""); Native.putBool(pData+36, v); }
	public int get_group() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_group(int v) { log.finest(""); Native.putInt(pData+40, v); }
	public int get_mods() { log.finest("");return (Native.getInt(pData+44)); }
	public void set_mods(int v) { log.finest(""); Native.putInt(pData+44, v); }
	public byte get_message(int index) { log.finest("");return Native.getByte(pData + 48+index*1); }
	public void set_message(int index, byte v) { log.finest(""); Native.putByte(pData+48 + index*1, v); }
	public long get_message() { log.finest("");return pData+48; }
