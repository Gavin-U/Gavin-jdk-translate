...
public class XkbNamesNotifyEvent extends XWrapperBase { 
	...
	public static int getSize() { return 76; }
	...
	public int get_first_type() { log.finest("");return (Native.getInt(pData+32)); }
	public void set_first_type(int v) { log.finest(""); Native.putInt(pData+32, v); }
	public int get_num_types() { log.finest("");return (Native.getInt(pData+36)); }
	public void set_num_types(int v) { log.finest(""); Native.putInt(pData+36, v); }
	public int get_first_lvl() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_first_lvl(int v) { log.finest(""); Native.putInt(pData+40, v); }
	public int get_num_lvls() { log.finest("");return (Native.getInt(pData+44)); }
	public void set_num_lvls(int v) { log.finest(""); Native.putInt(pData+44, v); }
	public int get_num_aliases() { log.finest("");return (Native.getInt(pData+48)); }
	public void set_num_aliases(int v) { log.finest(""); Native.putInt(pData+48, v); }
	public int get_num_radio_groups() { log.finest("");return (Native.getInt(pData+52)); }
	public void set_num_radio_groups(int v) { log.finest(""); Native.putInt(pData+52, v); }
	public int get_changed_vmods() { log.finest("");return (Native.getInt(pData+56)); }
	public void set_changed_vmods(int v) { log.finest(""); Native.putInt(pData+56, v); }
	public int get_changed_groups() { log.finest("");return (Native.getInt(pData+60)); }
	public void set_changed_groups(int v) { log.finest(""); Native.putInt(pData+60, v); }
	public int get_changed_indicators() { log.finest("");return (Native.getInt(pData+64)); }
	public void set_changed_indicators(int v) { log.finest(""); Native.putInt(pData+64, v); }
	public int get_first_key() { log.finest("");return (Native.getInt(pData+68)); }
	public void set_first_key(int v) { log.finest(""); Native.putInt(pData+68, v); }
	public int get_num_keys() { log.finest("");return (Native.getInt(pData+72)); }
	public void set_num_keys(int v) { log.finest(""); Native.putInt(pData+72, v); }
