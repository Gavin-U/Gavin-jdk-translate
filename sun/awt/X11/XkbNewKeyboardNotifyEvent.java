...
public class XkbNewKeyboardNotifyEvent extends XWrapperBase { 
	...
	public int get_old_device() { log.finest("");return (Native.getInt(pData+28)); }
	public void set_old_device(int v) { log.finest(""); Native.putInt(pData+28, v); }
	public int get_min_key_code() { log.finest("");return (Native.getInt(pData+32)); }
	public void set_min_key_code(int v) { log.finest(""); Native.putInt(pData+32, v); }
	public int get_max_key_code() { log.finest("");return (Native.getInt(pData+36)); }
	public void set_max_key_code(int v) { log.finest(""); Native.putInt(pData+36, v); }
	public int get_old_min_key_code() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_old_min_key_code(int v) { log.finest(""); Native.putInt(pData+40, v); }
	public int get_old_max_key_code() { log.finest("");return (Native.getInt(pData+44)); }
	public void set_old_max_key_code(int v) { log.finest(""); Native.putInt(pData+44, v); }
	...
	public byte get_req_major() { log.finest("");return (Native.getByte(pData+52)); }
	public void set_req_major(byte v) { log.finest(""); Native.putByte(pData+52, v); }
	public byte get_req_minor() { log.finest("");return (Native.getByte(pData+53)); }
	public void set_req_minor(byte v) { log.finest(""); Native.putByte(pData+53, v); }
