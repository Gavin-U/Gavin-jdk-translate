...
public class XkbMapNotifyEvent extends XWrapperBase { 
	...
	public int get_flags() { log.finest("");return (Native.getInt(pData+32)); }
	public void set_flags(int v) { log.finest(""); Native.putInt(pData+32, v); }
	public int get_first_type() { log.finest("");return (Native.getInt(pData+36)); }
	public void set_first_type(int v) { log.finest(""); Native.putInt(pData+36, v); }
	public int get_num_types() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_num_types(int v) { log.finest(""); Native.putInt(pData+40, v); }
	public int get_min_key_code() { log.finest("");return (Native.getInt(pData+44)); }
	public void set_min_key_code(int v) { log.finest(""); Native.putInt(pData+44, v); }
	public int get_max_key_code() { log.finest("");return (Native.getInt(pData+45)); }
	public void set_max_key_code(int v) { log.finest(""); Native.putInt(pData+45, v); }
	public int get_first_key_sym() { log.finest("");return (Native.getInt(pData+46)); }
	public void set_first_key_sym(int v) { log.finest(""); Native.putInt(pData+46, v); }
	public int get_first_key_act() { log.finest("");return (Native.getInt(pData+47)); }
	public void set_first_key_act(int v) { log.finest(""); Native.putInt(pData+47, v); }
	public int get_first_key_behavior() { log.finest("");return (Native.getInt(pData+48)); }
	public void set_first_key_behavior(int v) { log.finest(""); Native.putInt(pData+48, v); }
	public int get_first_key_explicit() { log.finest("");return (Native.getInt(pData+49)); }
	public void set_first_key_explicit(int v) { log.finest(""); Native.putInt(pData+49, v); }
	public int get_first_modmap_key() { log.finest("");return (Native.getInt(pData+50)); }
	public void set_first_modmap_key(int v) { log.finest(""); Native.putInt(pData+50, v); }
	public int get_first_vmodmap_key() { log.finest("");return (Native.getInt(pData+51)); }
	public void set_first_vmodmap_key(int v) { log.finest(""); Native.putInt(pData+51, v); }
	public int get_num_key_syms() { log.finest("");return (Native.getInt(pData+52)); }
	public void set_num_key_syms(int v) { log.finest(""); Native.putInt(pData+52, v); }
	public int get_num_key_acts() { log.finest("");return (Native.getInt(pData+56)); }
	public void set_num_key_acts(int v) { log.finest(""); Native.putInt(pData+56, v); }
	public int get_num_key_behaviors() { log.finest("");return (Native.getInt(pData+60)); }
	public void set_num_key_behaviors(int v) { log.finest(""); Native.putInt(pData+60, v); }
	public int get_num_key_explicit() { log.finest("");return (Native.getInt(pData+64)); }
	public void set_num_key_explicit(int v) { log.finest(""); Native.putInt(pData+64, v); }
	public int get_num_modmap_keys() { log.finest("");return (Native.getInt(pData+68)); }
	public void set_num_modmap_keys(int v) { log.finest(""); Native.putInt(pData+68, v); }
	public int get_num_vmodmap_keys() { log.finest("");return (Native.getInt(pData+72)); }
	public void set_num_vmodmap_keys(int v) { log.finest(""); Native.putInt(pData+72, v); }
	public int get_vmods() { log.finest("");return (Native.getInt(pData+76)); }
	public void set_vmods(int v) { log.finest(""); Native.putInt(pData+76, v); }
