...
public class XkbCompatMapNotifyEvent extends XWrapperBase { 
	...
	public int get_changed_groups() { log.finest("");return (Native.getInt(pData+28)); }
	public void set_changed_groups(int v) { log.finest(""); Native.putInt(pData+28, v); }
	public int get_first_si() { log.finest("");return (Native.getInt(pData+32)); }
	public void set_first_si(int v) { log.finest(""); Native.putInt(pData+32, v); }
	public int get_num_si() { log.finest("");return (Native.getInt(pData+36)); }
	public void set_num_si(int v) { log.finest(""); Native.putInt(pData+36, v); }
	public int get_num_total_si() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_num_total_si(int v) { log.finest(""); Native.putInt(pData+40, v); }
