...
public class XkbStateNotifyEvent extends XWrapperBase { 
	...
	public int get_group() { log.finest("");return (Native.getInt(pData+32)); }
	public void set_group(int v) { log.finest(""); Native.putInt(pData+32, v); }
	public int get_base_group() { log.finest("");return (Native.getInt(pData+36)); }
	public void set_base_group(int v) { log.finest(""); Native.putInt(pData+36, v); }
	public int get_latched_group() { log.finest("");return (Native.getInt(pData+40)); }
	public void set_latched_group(int v) { log.finest(""); Native.putInt(pData+40, v); }
	public int get_locked_group() { log.finest("");return (Native.getInt(pData+44)); }
	public void set_locked_group(int v) { log.finest(""); Native.putInt(pData+44, v); }
	public int get_mods() { log.finest("");return (Native.getInt(pData+48)); }
	public void set_mods(int v) { log.finest(""); Native.putInt(pData+48, v); }
	public int get_base_mods() { log.finest("");return (Native.getInt(pData+52)); }
	public void set_base_mods(int v) { log.finest(""); Native.putInt(pData+52, v); }
	public int get_latched_mods() { log.finest("");return (Native.getInt(pData+56)); }
	public void set_latched_mods(int v) { log.finest(""); Native.putInt(pData+56, v); }
	public int get_locked_mods() { log.finest("");return (Native.getInt(pData+60)); }
	public void set_locked_mods(int v) { log.finest(""); Native.putInt(pData+60, v); }
	public int get_compat_state() { log.finest("");return (Native.getInt(pData+64)); }
	public void set_compat_state(int v) { log.finest(""); Native.putInt(pData+64, v); }
	public byte get_grab_mods() { log.finest("");return (Native.getByte(pData+68)); }
	public void set_grab_mods(byte v) { log.finest(""); Native.putByte(pData+68, v); }
	public byte get_compat_grab_mods() { log.finest("");return (Native.getByte(pData+69)); }
	public void set_compat_grab_mods(byte v) { log.finest(""); Native.putByte(pData+69, v); }
	public byte get_lookup_mods() { log.finest("");return (Native.getByte(pData+70)); }
	public void set_lookup_mods(byte v) { log.finest(""); Native.putByte(pData+70, v); }
	public byte get_compat_lookup_mods() { log.finest("");return (Native.getByte(pData+71)); }
	public void set_compat_lookup_mods(byte v) { log.finest(""); Native.putByte(pData+71, v); }
	public int get_ptr_buttons() { log.finest("");return (Native.getInt(pData+72)); }
	public void set_ptr_buttons(int v) { log.finest(""); Native.putInt(pData+72, v); }
	public int get_keycode() { log.finest("");return (Native.getInt(pData+76)); }
	public void set_keycode(int v) { log.finest(""); Native.putInt(pData+76, v); }
	public byte get_event_type() { log.finest("");return (Native.getByte(pData+77)); }
	public void set_event_type(byte v) { log.finest(""); Native.putByte(pData+77, v); }
	public byte get_req_major() { log.finest("");return (Native.getByte(pData+78)); }
	public void set_req_major(byte v) { log.finest(""); Native.putByte(pData+78, v); }
	public byte get_req_minor() { log.finest("");return (Native.getByte(pData+79)); }
	public void set_req_minor(byte v) { log.finest(""); Native.putByte(pData+79, v); }
